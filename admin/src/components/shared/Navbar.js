...
function Navbar() {
  ...
  const activeUser = checkJSON(user);
    ...
    <>
      <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <Link id="logo" className="navbar-brand brand-logo" to="/"><img src={require('../../assets/images/logo.svg')} alt="logo" /></Link>
          <Link id="brand" className="navbar-brand brand-logo-mini" to="/"><img src={require('../../assets/images/logo-mini.svg')} alt="logo" /></Link>
        </div>
              ...
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link">
                  ...
                  <div className="nav-profile-text">
                    <p className="mb-1 text-black"><Trans>{activeUser ? activeUser.userName : null}</Trans></p>
                  </div>
                </Dropdown.Toggle>
                ...
                <Dropdown.Menu className="navbar-dropdown">
                  ...
                  <Dropdown.Item onClick={signOutUser}>
                    ...
                    {/* <Link id='logout' to='/' style={{ color: 'black', textDecoration: 'none' }}> */}
